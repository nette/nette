...
All Nette components are 100% compatible with PHP 7. Minimal required version is PHP 5.3.1. Please
run [Requirements Checker](https://doc.nette.org/requirements) to obtain more detailed information.
