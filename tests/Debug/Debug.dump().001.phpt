...
<pre class="dump"><span>array</span>(5) <code>[
   0 => 1
   1 => "hello" (5)
   2 => <span>array</span>(0)
...
<pre class="dump"><span>stream resource</span>
</pre>
<pre class="dump"><span>stdClass</span>(0)
</pre>
<pre class="dump"><span>Test</span>(3) <code>{
