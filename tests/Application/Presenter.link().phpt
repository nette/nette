...
class TestPresenter extends Nette\Application\Presenter
{
	...
	protected function startup()
	{
		...
		Assert::same( '/index.php?action=product&presenter=Test', $uri );


		$uri = $this->link('product', array('var1' => $this->var1 * 2, 'ok' => TRUE));
		Assert::same( '/index.php?var1=20&action=product&presenter=Test', $uri );


		$uri = $this->link('product', array('var1' => TRUE, 'ok' => '0'));
		Assert::same( '/index.php?var1=1&ok=0&action=product&presenter=Test', $uri );
		...
		Assert::same( "error: Extra parameter for 'Test:product'.", $uri );


		$uri = $this->link('product', array('x' => 1, 'y' => 2));
		Assert::same( '/index.php?x=1&y=2&action=product&presenter=Test', $uri );
		...
		$uri = $this->link('');
		Assert::same( 'error: Destination must be non-empty string.', $uri );
		...
		Assert::same( '/index.php?x=1&y=2&action=product&presenter=Test#fragment', $uri );


		$uri = $this->link('//product?x=1&y=2#fragment');
		Assert::same( 'http://localhost/index.php?x=1&y=2&action=product&presenter=Test#fragment', $uri );
		...
		Assert::same( '/index.php?action=default&do=buy&presenter=Test', $uri );


		$uri = $this->link('buy!', array('var1' => $this->var1 * 2));
		Assert::same( '/index.php?var1=20&action=default&do=buy&presenter=Test', $uri );


		$uri = $this->link('buy!', 1, 2);
		Assert::same( '/index.php?y=2&action=default&do=buy&presenter=Test', $uri );
		...
		Assert::same( '/index.php?y=0&action=default&do=buy&presenter=Test', $uri );
		...
		$uri = $this->link('!');
		Assert::same( 'error: Signal must be non-empty string.', $uri );


		$uri = $this->link('this', array('var1' => $this->var1));
		Assert::same( '/index.php?action=default&presenter=Test', $uri );
		...
		Assert::same( '/index.php?mycontrol-x=0&mycontrol-y=1&action=default&do=mycontrol-click&presenter=Test', $uri );


		$uri = $this->mycontrol->link('click', '0a', '1a');
		Assert::same( '/index.php?mycontrol-x=0a&mycontrol-y=1a&action=default&do=mycontrol-click&presenter=Test', $uri );


		$uri = $this->mycontrol->link('click', array(1), (object) array(1));
		Assert::same( '/index.php?mycontrol-x=1&action=default&do=mycontrol-click&presenter=Test', $uri );
		...
		Assert::same( '/index.php?action=default&do=mycontrol-click&presenter=Test', $uri );


		$uri = $this->mycontrol->link('click', 1, 2, 3);
		Assert::same( "error: Extra parameter for signal 'TestControl:handleclick'.", $uri );


		$uri = $this->mycontrol->link('click!', array('x' => 1, 'y' => 2, 'round' => 0));
		Assert::same( '/index.php?mycontrol-x=1&mycontrol-y=2&action=default&do=mycontrol-click&presenter=Test', $uri );


		$uri = $this->mycontrol->link('click', array('x' => 1, 'round' => 1));
		Assert::same( '/index.php?mycontrol-x=1&mycontrol-round=1&action=default&do=mycontrol-click&presenter=Test', $uri );


		$uri = $this->mycontrol->link('this', array('x' => 1, 'round' => 1));
		Assert::same( '/index.php?mycontrol-x=1&mycontrol-round=1&action=default&presenter=Test', $uri );
		...
		Assert::same( '/index.php?mycontrol-x=1&mycontrol-round=1&action=default&presenter=Test#frag', $uri );


		$uri = $this->mycontrol->link('//this?x=1&round=1#frag');
		Assert::same( 'http://localhost/index.php?mycontrol-x=1&mycontrol-round=1&action=default&presenter=Test#frag', $uri );
