...
/**
 * Test: Nette\Diagnostics\Dumper::toHtml()
 *
 * @author     David Grudl
...
Assert::match( '<pre class="nette-dump"><span class="nette-dump-object">stdClass</span> <span class="nette-dump-hash">#%h%</span>
</pre>', Dumper::toHtml(new stdClass) );

Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-object">Test</span> <span class="nette-toggle-stop"><a href="editor://%a%" title="Open source file">(source)</a></span> <span class="nette-dump-hash">#%h%</span></span>
...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle-collapsed"><span class="nette-dump-object">Test</span> <span class="nette-toggle-stop"><a href="editor://%a%" title="Open source file">(source)</a></span> <span class="nette-dump-hash">#%h%</span></span>
...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-object">Closure</span> <span class="nette-toggle-stop"><a href="editor://%a%" title="Open source file">(source)</a></span> <span class="nette-dump-hash">#%h%</span></span>
...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-object">SplFileInfo</span> <span class="nette-dump-hash">#%h%</span></span>
