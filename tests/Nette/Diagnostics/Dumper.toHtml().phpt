...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-object">Test</span> <span class="nette-toggle-stop"><a href="editor://%a%" title="Open source file">(source)</a></span> <span class="nette-dump-hash">#%a%</span></span>
...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle-collapsed"><span class="nette-dump-object">Test</span> <span class="nette-toggle-stop"><a href="editor://%a%" title="Open source file">(source)</a></span> <span class="nette-dump-hash">#%a%</span></span>
...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-object">Closure</span> <span class="nette-toggle-stop"><a href="editor://%a%" title="Open source file">(source)</a></span> <span class="nette-dump-hash">#%a%</span></span>
