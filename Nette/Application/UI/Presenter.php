...
abstract class Presenter extends Control implements Application\IPresenter
{
	...
	{
		return $this->context->findByClass('Nette\Http\IRequest');
	}
	...
	{
		return $this->context->findByClass('Nette\Http\IResponse');
	}
	...
	{
		return $this->context->findByClass('Nette\Http\Context');
	}
	...
	{
		return $this->context->findByClass('Nette\Application\Application');
	}
	...
	{
		$handler = $this->context->findByClass('Nette\Http\Session');
	...
	{
		return $this->context->findByClass('Nette\Http\IUser');
	}
