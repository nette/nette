...
class RobotLoader extends AutoLoader
{
	...
	{
		$this->list = $this->getCache()->load($this->getKey(), new Nette\Callback(array($this, '_rebuildCallback')));
	...
	{
		$this->getCache()->save($this->getKey(), new Nette\Callback(array($this, '_rebuildCallback')));
		$this->rebuilt = TRUE;
	}
