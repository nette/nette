...
class User extends Nette\Object implements IUser
{
	...
	{
		return $this->authenticator ?: $this->context->findByClass('Nette\Security\IAuthenticator');
	}
	...
	{
		return $this->authorizator ?: $this->context->findByClass('Nette\Security\IAuthorizator');
	}
