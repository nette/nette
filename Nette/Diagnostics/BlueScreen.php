...
class BlueScreen extends Nette\Object
{
	...
	public static function highlightPhp($source, $line, $lines = 15, $vars = array())
	{
		...
		$out .= static::highlightSourceLine($source, $line, $lines);
	...
	/**
	 * Returns highlighted line in source code.
	 * @param  array
	 * @param  int
	 * @param  int
	 * @reutrn string
	 */
	public static function highlightSourceLine(array $source, $line, $lines = 15)
	{
		$out = '';
		$spans = 1;
