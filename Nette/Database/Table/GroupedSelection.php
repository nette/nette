...
class GroupedSelection extends Selection
{
	...
	{
		$aggregation = & $this->getRefTable($refPath)->aggregation[$refPath . $function . $this->sqlBuilder->buildSelectQuery($this) . json_encode($this->sqlBuilder->getParameters())];
	...
	protected function execute()
	{
		...
		$hash = md5($this->sqlBuilder->buildSelectQuery($this) . json_encode($this->sqlBuilder->getParameters()));
