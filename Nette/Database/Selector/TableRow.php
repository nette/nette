...
class TableRow extends Nette\Object implements \IteratorAggregate, \ArrayAccess
{
	...
	public function update($data = NULL)
	{
		...
		return $this->table->connection->table($this->table->name)->where($this->table->delimitedPrimary, $this[$this->table->primary])->update($data);
	}
	...
	{
		return $this->table->connection->table($this->table->name)->where($this->table->delimitedPrimary, $this[$this->table->primary])->delete();
	}
